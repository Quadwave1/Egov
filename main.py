...
def embed(): 
    ...
    documents = SimpleDirectoryReader("C:\\Users\\suhas.mr\\Desktop\\WORK\\Document_Summerization\\Doc_summ_frontend\\e_gov_flask\\doc_summary_send\\docs").load_data()


    # Create a local Qdrant vector store
    client1 = qdrant_client.QdrantClient(path="qdrant_db1")


    # Create collection
    vector_store = QdrantVectorStore(
        client=client1, collection_name="text_collection1")
